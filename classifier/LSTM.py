...
from keras.layers import Dropout, Embedding, Dense, LSTM, GlobalMaxPooling1D, Activation
...
def LSTM_model():
    ...
    return model
model=LSTM_model()
model.fit(x_train, y_train, batch_size=128,validation_data=(x_val, y_val), epochs=128,callbacks=callbacks)
